...
describe("Testa comportamento do componente ProductCard", () => {
    ...
    it("Retorna true se os itens de redes sociais est]ao visíveis ", () => {
    ...
    it("Retorna true se os botão de contato está visível e possui link e verifica se o botão de horários está visível", () => {
    ...
    describe("Testa comportamento do componente ProductCard", () => {
        ...
        it("Retorna true se todas os itens e o componente de productCard estão visíveis", () => {
